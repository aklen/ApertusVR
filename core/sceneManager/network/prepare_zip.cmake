...
if(NOT ANDROID)
	...
	elseif(APPLE)
		if (APPLE_M1)
			message (STATUS "zip: prepare on Apple M1 (arm)")
			set(ZIP_STATIC_LIB_PATH_DEBUG "${ZIP_BUILD_DIR}/libzip.a")
			set(ZIP_STATIC_LIB_PATH_RELEASE "${ZIP_BUILD_DIR}/libzip.a")
		else ()
		message (STATUS "zip: prepare on Apple x86")
			set(ZIP_STATIC_LIB_PATH_DEBUG "${ZIP_BUILD_DIR}/Debug/libzip.a")
			set(ZIP_STATIC_LIB_PATH_RELEASE "${ZIP_BUILD_DIR}/Release/libzip.a")
		endif ()
	elseif (LINUX)
		message (STATUS "zip: prepare on Linux")
		set(ZIP_STATIC_LIB_PATH_DEBUG "${ZIP_BUILD_DIR}/libzip.a")
		set(ZIP_STATIC_LIB_PATH_RELEASE "${ZIP_BUILD_DIR}/libzip.a")
	endif ()
	...
	if (EXISTS "${ZIP_STATIC_LIB_PATH_DEBUG}" OR EXISTS "${ZIP_STATIC_LIB_PATH_RELEASE}")
		set(ZIP_READY TRUE)
	...
	if (NOT ZIP_READY)
		...
		foreach (CONF ${CMAKE_CONFIGURATION_TYPES})
			...
			execute_process (
					...
					-DCMAKE_CXX_FLAGS=${EXTRA_COMPILE_OPTIONS}
					-DCMAKE_C_FLAGS=${EXTRA_COMPILE_OPTIONS}
