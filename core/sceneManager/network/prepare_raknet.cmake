...
set (RAKNET_SRC_DIR ${APE_THIRDPARTY_DIR}/raknet)
...
if(NOT ANDROID)
	...
	elseif (APPLE)
		if (APPLE_M1)
			message (STATUS "RakNet: prepare on Apple M1 (arm)")
		...
		message (STATUS "RakNet: prepare on Apple x86")
	...
	set_property(TARGET RAKNET PROPERTY IMPORTED_LOCATION ${RAKNET_STATIC_LIB_PATH_RELEASE})
